...
<div class="wrap">
	...
	<form method="post" action="">
		...
		<table class="form-table">
			<tr>
				<th><?php esc_html_e( 'Redis Host', 'redis-queue-demo' ); ?></th>
			...
			<tr>
				<th><?php esc_html_e( 'Redis Port', 'redis-queue-demo' ); ?></th>
			...
			<tr>
				<th><?php esc_html_e( 'Redis Database', 'redis-queue-demo' ); ?></th>
			...
			<tr>
				<th><?php esc_html_e( 'Redis Password', 'redis-queue-demo' ); ?></th>
			...
			<tr>
				<th><?php esc_html_e( 'Worker Timeout', 'redis-queue-demo' ); ?></th>
			...
			<tr>
				<th><?php esc_html_e( 'Max Retries', 'redis-queue-demo' ); ?></th>
			...
			<tr>
				<th><?php esc_html_e( 'Retry Delay', 'redis-queue-demo' ); ?></th>
			...
			<tr>
				<th><?php esc_html_e( 'Batch Size', 'redis-queue-demo' ); ?></th>
			...
			<tr>
				<th><?php esc_html_e( 'API Token', 'redis-queue-demo' ); ?></th>
				<td><?php if ( ! empty( $options[ 'api_token' ] ) ) : ?><code
							...
							style="display:inline-block; margin-top:6px;"><input type="checkbox" name="clear_api_token"
								value="1" />
							<?php esc_html_e( 'Clear token on save', 'redis-queue-demo' ); ?></label><?php else : ?><em><?php esc_html_e( 'No token set.', 'redis-queue-demo' ); ?></em><?php endif; ?>
					...
					<p style="margin-top:8px;"><button type="submit" name="generate_api_token"
							class="button"><?php echo empty( $options[ 'api_token' ] ) ? esc_html__( 'Generate Token', 'redis-queue-demo' ) : esc_html__( 'Regenerate Token', 'redis-queue-demo' ); ?></button>
					</p>
				</td>
			</tr>
			<tr>
				<th><?php esc_html_e( 'Token Scope', 'redis-queue-demo' ); ?></th>
			...
			<tr>
				<th><?php esc_html_e( 'Rate Limit (per minute)', 'redis-queue-demo' ); ?></th>
			...
			<tr>
				<th><?php esc_html_e( 'Request Logging', 'redis-queue-demo' ); ?></th>
			...
			<tr>
				<th><?php esc_html_e( 'Log Rotation', 'redis-queue-demo' ); ?></th>
				<td><label><?php esc_html_e( 'Max File Size (KB):', 'redis-queue-demo' ); ?> <input type="number"
							name="log_rotate_size_kb" value="<?php echo esc_attr( $options[ 'log_rotate_size_kb' ] ); ?>"
							class="small-text" min="8" max="16384" /></label> <label
						style="margin-left:12px;"><?php esc_html_e( 'Max Files:', 'redis-queue-demo' ); ?> <input
	...
	<div class="redis-queue-connection-test">
		<h2><?php esc_html_e( 'Connection Test', 'redis-queue-demo' ); ?></h2><button type="button" class="button"
			id="test-redis-connection"><?php esc_html_e( 'Test Redis Connection', 'redis-queue-demo' ); ?></button>
